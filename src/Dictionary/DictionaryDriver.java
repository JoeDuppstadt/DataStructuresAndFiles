...
public class DictionaryDriver {
    ...
    public static void main(String[] args) {
        ...
        LinkedDictionary<Object, Object> d = new LinkedDictionary<>();
        ...
        System.out.println(d.contains("Orange"));
        Iterator<Object> kit = d.keys().iterator();
        Iterator<Object> vit = d.values().iterator();
